  ...
  render() {
    return (
      <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme}>
        ...
        <Slide transition={["slide"]} bgColor="black" notes="">
          <Heading size={4} textColor="primary" margin="0.5rem auto 40px">
            handle_call
          </Heading>
          <Layout>
            <Fill>
        ...
        <Slide transition={["slide"]} bgColor="black" notes="">
          ...
          <List textColor="primary">
            <ListItem>Square = Supervisor</ListItem>
            <ListItem>Circle = Worker</ListItem>
          </List>
        </Slide>
        <Slide transition={["slide"]} bgColor="black" notes="">
          <Text textColor="tertiary">
        ...
        <Slide transition={["slide"]} bgColor="black" notes="">
          <Layout>
            ...
            <Fill>
              <BlockQuote>
                <Quote>"New language, same distributed web patterns you love"</Quote>
                <Cite>- Phoenix marketing slogan</Cite>
              </BlockQuote>
            </Fill>
          </Layout>
        </Slide>
        ...
        <Slide transition={["slide"]} bgColor="black" notes="">
          <Layout>
            ...
            <Fill>
              ...
              <Appear>
                <Text textColor="tertiary">
                  ...the Erlang concurrency model and OTP!
                </Text>
              </Appear>
            </Fill>
          </Layout>
